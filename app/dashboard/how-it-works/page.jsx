    ...
    <div className="p-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 border rounded-lg shadow-sm">
          ...
          <p>Provide job details and requirements to generate tailored interview questions.</p>
        </div>
        <div className="p-6 border rounded-lg shadow-sm">
          <h2 className="text-xl font-semibold mb-2">2. Answer Questions</h2>
          <p>Record your answers using your microphone for each AI-generated question.</p>
        </div>
        <div className="p-6 border rounded-lg shadow-sm">
          <h2 className="text-xl font-semibold mb-2">3. Get Feedback</h2>
          <p>Receive instant, AI-powered feedback and a summary score for your performance.</p>
        </div>
      </div>
    </div>
  );
